...
def create_board_failed():
    fmt = _("Failed to create bulletin board. \n\n"
            "Ask the FAQ Bot manager to check if the bulletin board "
            "creation item has been set incorrectly or if the bulletin "
            "board title or description has exceeded the character limit.")
    ...
    return make_text("Failed to create bulletin board. \n\n"
                     ...
                     "has exceeded the character limit.", "message", fmt)

def create_articles_failed():
    fmt = _("Failed to complete posting. \n\n"
            "Ask the FAQ Bot manager to check if the bulletin board "
            "number does not exist or if other items are set up incorrectly.")
    return make_text("Failed to complete posting. \n\n"
                     "Ask the FAQ Bot manager to check if the bulletin board "
                     "number does not exist or if other "
                     "items are set up incorrectly.", "message", fmt)
